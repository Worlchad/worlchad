...
<div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30">Worlchad Videos</p>
                            <div class="row"><a  href="{{route('videos.create')}}" class="btn btn-info btn-rounded pull-right">Upload Video</a></div><br>   
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    @forelse($videos as $video)
                                        <tr>
                                            ...
                                            <td>{{ucwords($video->category->name)}}</td>
                                            <td>{{$video->key}}</td>
                                            <td>{{$video->created_at}}</td>
                                            <td>{{$video->updated_at}}</td>
                                            <td>
                                                <a href="#"><i class="btn btn-success btn-outline btn-circle fa fa-eye"></i> </a>
                                                <a href="{{route('videos.edit',$video->id)}}"><i class="btn btn-info btn-outline btn-circle fa fa-edit"></i></a>
