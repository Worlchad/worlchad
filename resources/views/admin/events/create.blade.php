                        ...
                        <div class="white-box">
                            ...
                            <input type="hidden" value="{{auth()->guard('admin')->user()->id}}" name="admin_id"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                       <input class="form-control input-daterange-datepicker" type="text" name="date" value="{{date('m/d/Y')}} - {{date('m/d/Y')}}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" value="" name="venue"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" value="" name="tags"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="" name="participant_price" value="" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-sm-12">Attendee Price</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="" name="attendee_price" value="" class="form-control" />
                                        </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="submit" class="btn btn-primary pull-right" value="Add Event"> </div>
                                </div>
                            </form>
                        </div>
                    </div>
